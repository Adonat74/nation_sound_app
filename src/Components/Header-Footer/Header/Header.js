...
export default function Header (props) {
    ...
    return(
            <div className="header">
                <Link to="/accueil" onClick={() => props.setMenuToggle(false)}><img className="logo" src="/images/logo.png" alt="Logo Nation Sound"></img></Link>
                <div className="menu">
                    <Link to="/accueil" className="elementsMenu">Accueil</Link>
